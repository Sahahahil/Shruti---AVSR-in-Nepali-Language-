...
class Config:
    VSR_CHECKPOINT = "/mnt/documents/Major-Project/auto_avsr_hf/vsr_scratch/v5/best_model.pth"
    WAV2VEC_PATH   = "/mnt/documents/Major-Project/auto_avsr_hf/asr_weights/wav2vec2-weights/checkpoint-9200"
    WAV2VEC_PROCESSOR_PATH = "/mnt/documents/Major-Project/auto_avsr_hf/asr_weights/wav2vec2-weights/wav2vec2-nepali-processor-20260315T054231Z-1-001/wav2vec2-nepali-processor"
